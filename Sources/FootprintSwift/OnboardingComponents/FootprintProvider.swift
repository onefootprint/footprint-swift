...
public final class FootprintProvider {
    ...
    private var vaultData: Vaultprops?
    ...
    public func verify(verificationCode: String) async throws -> Verify {
        ...
        var updatedVaultData: Vaultprops? = nil
    ...
    public func getVaultData() async throws -> Vaultprops {
    ...
    public func vault(vaultData: Vaultprops) async throws {
        guard let obConfigKind = self.onboardingConfig?.kind else {
